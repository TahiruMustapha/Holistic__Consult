      ...
      <div className="about-text-info">
        <div className="about-info">
          <div className="about-details">
            <h3>About Us</h3>
            <p>
              Holistic Counselling and Training Consult Ltd is a limited
              liability company established to train and develop skills and
              relevant knowledge in the practice of care, Counselling, and
              Coaching in church and beyond. Its personnel and vast skill
              development courses are accredited by the Ghana Psychology
              Council.
            </p>
          </div>
        ...
        <div className="different">
          ...
          <div className="different-details">
            ...
            <p>
              Since its inception, Holistic Counselling and Training Consult has
              provided comprehensive and contextualized support services to both
              the young and old to improve their physical, emotional,
              socio-economic, spiritual, and educational well-being. This has
              been accomplished under the able leadership of renowned,
              experienced, and certified counselors and a team of competent
              individuals with rich experiences in related fields of study.
            </p>
          </div>
        </div>
      </div>
